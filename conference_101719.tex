...
初期の VPR は，SIFT や SURF などの local descriptor を bag-of-words[] や VLAD[] により固定長ベクトルに変換し，画像検索タスクに拡張する形式が取られていた．
その後，NetVLAD[] や GeM[]，CosPlace[]，AnyLoc\cite{ref:AnyLoc} といった深層学習ベースの手法が登場し，高い性能を発揮している．
